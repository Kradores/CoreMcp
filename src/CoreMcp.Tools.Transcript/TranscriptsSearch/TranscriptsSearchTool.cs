...
public sealed class TranscriptsSearchTool : IMcpTool<TranscriptsSearchArguments>
{
    ...
    public ToolDescriptor Definition => new(
        ...
        Description:
            ...
            query is an optional keyword or phrase hint. date is an optional local calendar date in yyyy-MM-dd and is interpreted in UTC+0. fromUtc and toUtc are optional canonical UTC timestamps in yyyy-MM-ddTHH:mm:ss.ffffff+00:00. source is optional and can be system_audio or microphone. With no filters this returns the latest conversation.
